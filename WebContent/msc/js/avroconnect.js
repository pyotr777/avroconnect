// Load the Visualization API and the ready-made Google table visualization.
    ...
    function init() {
		...
		// LOAD PIGS
		if (dialect_pig) {
			xmlhttp.open('GET', '/avroconnect/getPigQueries?org=msc', true);
	...
	function sendRequest() {
		...
		var query_s = '/avroconnect/Avroconnect?tq='+escape(document.fields_form.query.value)+'&columns=' + escape(document.fields_form.columns.value);//+ '&csv='+ escape(document.fields_form.csv.value);		
		if (!dialect_pig) {
			var pig = encodeURIComponent(document.fields_form.hoplang.value);
			query_s = query_s + "&conf="+escape("config_graphit.txt");
		} else {
